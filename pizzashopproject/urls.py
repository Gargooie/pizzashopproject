...
urlpatterns = [
    ...
    path('pizzashop/sign-in/',LoginView.as_view
        (template_name= 'pizzashop/sign_in.html'),
        name='pizzashop-sign-in'),

  # url(r'pizzashop/sign-in/$', LoginView.as_view
  # (template_name='pizzashop/sign_in.html'),
  #      name='pizzashop-sign-in'),

    path('pizzashop/sign-out/',LogoutView.as_view
        (next_page='/'),
    ...
    path('pizzashop/pizza/edit/<pizza_id>/', views.pizzashop_edit_pizza,name='pizzashop-edit-pizza'),
